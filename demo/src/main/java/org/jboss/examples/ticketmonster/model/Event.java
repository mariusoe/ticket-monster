 ...
 * 
 * <p>
 * Event's principal members are it's relationship to {@link EventCategory} - specifying the type of
 * event it is - and {@link MediaItem} - providing the ability to add media (such as a picture) to
 * the event for display. It also contains meta-data about the event, such as it's name and a
 * description.
 * </p>
 * 
 * @author Shane Bryzak
...
public class Event implements Serializable {
	 ...
	 * <li><code>@Size</code> &mdash; the name must be at least 5 characters and no more than 50
	 * characters. This allows for better formatting consistency in the view layer.</li>
	 * </ol>
	 */
	@Column(unique = true)
	@NotNull
	 ...
	 * <li><code>@Size</code> &mdash; the name must be at least 20 characters and no more than 1000
	 * characters. This allows for better formatting consistency in the view layer, and also ensures
	 * that event organisers provide at least some description - a classic example of a business
	 * constraint.</li>
	 * </ol>
	 */
	@NotNull
	 ...
	 * 
	 * <p>
	 * Media items can be shared between events, so this is modeled as a <code>@ManyToOne</code>
	 * relationship.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Event categories are used to ease searching of available of events, and hence this is modeled
	 * as a relationship
	 * </p>
	 * 
	 * <p>
	 * The Bean Validation constraint <code>@NotNull</code> indicates that the event category must
	 * be specified.
	 */
	@ManyToOne
	@NotNull
