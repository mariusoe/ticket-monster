...
public class EventCategory implements Serializable {
	 ...
	 * 
	 * <p>
	 * The description of an event category forms it's natural id and cannot be shared between event
	 * categories
	 * </p>
	 * 
	 * <p>
	 * The <code>@NotEmpty<code> Bean Validation constraint means that the event category descripton
	 * must be least 1 character and cannot be null.
	 * </p>
	 */
	@Column(unique = true)
	@NotEmpty
	...
	/*
	 * toString(), equals() and hashCode() for EventCategory, using the natural identity of the
	 * object
	 */
