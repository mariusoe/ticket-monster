 ...
 * 
 * <p>
 * The show and date form the natural id of this entity, and therefore must be unique. JPA requires
...
public class Performance implements Serializable {
	 ...
	 * 
	 * <p>
	 * A Java {@link Date} object represents both a date and a time, whilst an RDBMS splits out
	 * Date, Time and Timestamp. Therefore we instruct JPA to store this date as a timestamp using
	 * the <code>@Temporal(TIMESTAMP)</code> annotation.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * The show of which this is a performance is required, and the Bean Validation constraint <code>@NotNull</code>
	 * enforces this.
	 * </p>
	 */
	@ManyToOne
