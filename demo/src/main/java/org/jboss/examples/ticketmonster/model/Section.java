...
public class Section implements Serializable {
	 ...
	 * 
	 * <p>
	 * The <code>@NotEmpty<code> Bean Validation constraint means that the section name must be at
	 * least 1 character.
	 * </p>
	 */
	@NotEmpty
	 ...
	 * 
	 * <p>
	 * The <code>@NotEmpty<code> Bean Validation constraint means that the section description must
