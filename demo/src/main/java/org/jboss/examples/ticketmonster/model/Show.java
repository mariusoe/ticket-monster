 ...
 * 
 * <p>
 * A show contains a set of performances, and a set of ticket prices for each section of the venue
 * for this show.
 * </p>
 * 
 * <p>
...
public class Show implements Serializable {
	 ...
	 * so, for example if a show is removed, then all of it's performances will also be removed.
	 * </p>
	 * 
	 * <p>
	 * Normally a collection is loaded from the database in the order of the rows, but here we want
	 * to make sure that performances are ordered by date - we let the RDBMS do the heavy lifting.
	 * The <code>@OrderBy<code> annotation instructs JPA to do this.
	 * </p>
	 */
	 ...
	 * attribute establishes this. We cascade all persistence operations to the set of performances,
	 * so, for example if a show is removed, then all of it's ticket price categories are also
	 * removed.
	 * </p>
	 */
