 ...
 * <code>BaseEntityService</code> class, and the other services can inherit from here.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * Subclasses may specify various criteria for filtering entities when retrieving a list of them, by
 * supporting custom query parameters. Pagination is supported by default through the query
 * parameters <code>first</code> and <code>maxResults</code>.
 * </p>
 *
 * <p>
 * The class is abstract because it is not intended to be used directly, but subclassed by actual
 * JAX-RS endpoints.
 * </p>
 *
 * 
...
public abstract class BaseEntityService<T> {
	 ...
	 * <code>first</code> and <code>maxResults</code> for pagination.
	 * </p>
	 *
	 * @param uriInfo
	 *            application and request context information (see {@see UriInfo} class information
	 *            for more details)
	 * @return
	 */
	@GET
	...
	/**
	 * <p>
	 * Subclasses may choose to expand the set of supported query parameters (for adding more
	 * filtering criteria on search and count) by overriding this method.
	 * </p>
	 * 
