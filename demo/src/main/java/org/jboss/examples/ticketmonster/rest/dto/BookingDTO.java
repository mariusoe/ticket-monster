...
public class BookingDTO implements Serializable {
	...
	public Booking fromDTO(Booking entity, EntityManager em) {
		...
		while (iterDtoTickets.hasNext()) {
			...
			if (found == false) {
				Iterator<Ticket> resultIter = em.createQuery("SELECT DISTINCT t FROM Ticket t", Ticket.class).getResultList().iterator();
		...
		if (this.performance != null) {
			entity.setPerformance(this.performance.fromDTO(entity.getPerformance(), em));
		}
